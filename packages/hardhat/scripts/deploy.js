...
const main = async () => {
  ...
  const yourContract = await deploy("YourContract"); // <-- add in constructor args like line 19 vvvvv
  // await yourContract.transfer("0x298D799551f223C7497B17227db502b5A31f27f5",""+100*10**18);
  ...
  await deployerWallet.sendTransaction({
    to: "0x298D799551f223C7497B17227db502b5A31f27f5",
